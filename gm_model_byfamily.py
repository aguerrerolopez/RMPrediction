...
for fold in range(10):
    ...
    for familia in familias:
        ...
        store_path = "Results/mediana_10fold_noard/HGM_10fold"+str(fold)+"_muestrascompensadas_2-12maldi_"+familia+"_prun"+str(hyper_parameters['sshiba']["pruning_crit"])+".pkl"
